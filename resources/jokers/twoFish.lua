...
local itemCfg = Collectables.utils.getItemConfig("Joker", "two_fish")
...
return {
    ...
    config = function() 
        return {
            key = "two_fish",
            name = localize("name_mod_two_fish", "mod_config"),
            stateTable = Collectables.loadState.items["Joker"]["two_fish"],
            refTable = Collectables.config.items["Joker"]["two_fish"],
            configItems = {
                {
                    type = "toggle",
                    refValue = "enabled",
